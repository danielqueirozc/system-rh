            ...
            <div className="grid grid-cols-3 gap-4 overflow-y-auto">
              <Card className="p-6 flex flex-col gap-10 justify-between border-purple">
                ...
                <div className="flex gap-2">
                  <button className="w-full flex justify-center items-center gap-4 py-1 border font-medium transition-colors border-purple rounded-lg hover:bg-purple hover:text-blue">
                    <SquarePen size={16} />
                    Editar
                  </button>

                  <button className="border border-purple px-2.5 py-1 rounded-lg hover:bg-purple">
